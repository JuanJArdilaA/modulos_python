...
Introducir el nombre de usuario de Github, en la parte superior derecha de GitHub, darle en profile, el que esta en la parte superior izquierda git config --global user.name nombreUsuario

Intrducir el correo con el que se registraron en GitHub git config --global user.email correoUsuario
